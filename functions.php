<?php
	...
	function load_parent_styles() {
    	...
    	wp_enqueue_style( 'divi-style', get_stylesheet_uri() , array(), MAIN_VERSION );
	}
	...
	// 	wp_register_script( 'euphorika-script', get_stylesheet_directory_uri() . '/assets/javascript/script.js', array( 'jquery' ), MAIN_VERSION, true ,'all');
 // 	  	wp_enqueue_script( 'euphorika-script');
	// }
